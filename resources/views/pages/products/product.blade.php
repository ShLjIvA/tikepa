...
@section('banner-h1') Product @endsection
@section('banner-link')
                ...
                <div class="col-lg-6">
                    <div class="s_Product_carousel">
                        <div class="single-prd-item">
                            <img class="img-fluid" src="{{asset($product->image)}}" alt="Product picture">
                        </div>
                        @foreach($product->gallery as $image)
                            <div class="single-prd-item">
                                <img class="img-fluid" src="{{asset($image->url)}}" alt="Product picture">
                            </div>
                        @endforeach
                        <div class="single-prd-item">
                            <img class="img-fluid" src="{{asset($product->image)}}" alt="Product picture">
