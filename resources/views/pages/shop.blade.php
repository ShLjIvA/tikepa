                        ...
                        <form action="#">
                            <ul>
                                @foreach($categories as $category)
                                    <li class="filter-list"><input class="pixel-radio" type="radio" id="{{ strtolower($category->name) }}" name="{{ strtolower($category->name) }}"><label for="{{ strtolower($category->name) }}">{{ $category->name }}<span> ({{count($category->articles)}}) </span></label></li>
                                @endforeach
                            </ul>
                        </form>
                    </div>
                        ...
                        <form action="#">
                            <ul>
                                @foreach($genders as $gender)
                                    <li class="filter-list"><input class="pixel-radio" type="radio" id="{{ strtolower($gender->gender) }}" name="{{ strtolower($gender->gender) }}"><label for="{{ strtolower($gender->gender) }}">{{ $gender->gender }}<span> ({{count($gender->articles)}}) </span></label></li>
                                @endforeach
                            </ul>
                        </form>
                    </div>
